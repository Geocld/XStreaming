export default {
  translation: {
    ...
    Success: '成功',
    ConfigTransfer: '配置转移',
    ConfigTransferDescription: '导出或导入账号、设置、虚拟按键和宏配置。',
    ConfigTransferUnavailable: '当前设备不支持配置转移',
    ExportDesc: '导出配置',
    ExportTips:
      '将账号令牌、设置、自定义虚拟按键和宏设置导出为明文 JSON 文件。',
    ExportSettings: '导出设置',
    ExportSuccess: '导出成功',
    ExportFail: '导出失败',
    ImportDesc: '导入配置',
    ImportTips: '导入此前导出的 XStreaming JSON 文件，恢复后会重启应用。',
    ImportSettings: '导入设置',
    ImportSuccess: '导入成功',
    ImportFail: '导入失败',
    UserCancel: '已取消',
...
4. xCloud目前微软调整分辨率策略，部分游戏Xbox Game Pass Ultimate级别会员目前只支持720P/1440P分辨率`,
    ...
    GamepadTestDescription: '测试当前手柄的按键、摇杆、扳机和震动',
    GamepadKernelTitle: '当前内核',
    GamepadTestRumble: '测试震动',
    GamepadTestButtons: '按键',
    GamepadTestSticks: '摇杆',
    GamepadTestTriggers: '扳机',
    Edit: '编辑',
    Australia: '澳大利亚',
    Brazil1: '巴西1',
    Brazil2: '巴西2',
    ...
    Relevance: '相关度',
    'Account Tier': '账户等级',
    'Select Account Tier': '选择账户等级',
    'Select Cloud Server': '选择云游戏服务器',
    'Cloud Server': '云游戏服务器',
    Favorites: '收藏',
    ...
    'Per video frame': '每帧视频',
    'Delivered profile': '推流规格',
    "Don't show session reports again": '不再显示会话报告',
    Excellent: '极佳',
    Good: '良好',
    Fair: '一般',
    Poor: '较差',
