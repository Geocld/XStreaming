export default {
  translation: {
    ...
    'Auto Sprint': 'ऑटो स्प्रिंट',
    AutoSprintDesc:
      'लेफ्ट स्टिक हिलाने पर L3 अपने आप दबेगा और स्टिक सेंटर में लौटने पर छूट जाएगा।',
    noAllow:
    ...
    Default: 'डिफ़ॉल्ट',
    SDL: 'SDL',
    GamepadTestTitle: 'गेमपैड टेस्ट',
    GamepadTestDescription:
      'मौजूदा गेमपैड के बटन, स्टिक, ट्रिगर और वाइब्रेशन टेस्ट करें',
    GamepadKernelTitle: 'मौजूदा कर्नेल',
    GamepadTestRumble: 'वाइब्रेशन टेस्ट',
    GamepadTestButtons: 'बटन',
    GamepadTestSticks: 'स्टिक',
    GamepadTestTriggers: 'ट्रिगर',
    Edit: 'संपादित करें',
