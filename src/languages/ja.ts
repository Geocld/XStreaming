export default {
  translation: {
    ...
    Default: 'デフォルト',
    SDL: 'SDL',
    GamepadTestTitle: 'ゲームパッドテスト',
    GamepadTestDescription:
      '現在のゲームパッドのボタン、スティック、トリガー、振動をテストします',
    GamepadKernelTitle: '現在のカーネル',
    GamepadTestRumble: '振動テスト',
    GamepadTestButtons: 'ボタン',
    GamepadTestSticks: 'スティック',
    GamepadTestTriggers: 'トリガー',
    Edit: '編集',
    Australia: 'オーストラリア',
    Brazil1: 'ブラジル 1',
    Brazil2: 'ブラジル 2',
